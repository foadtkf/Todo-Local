...
const Banner = () => {
    return (
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
          <h3 className='text-black font-monospace fw-bolder'>Hello there 👋</h3>
          <p className='text-black font-monospace fw-bolder'>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img
        ...
        <Carousel.Caption>
          <h3 className='text-black font-monospace fw-bolder'>What are the most memorables</h3>
          <p className='text-black font-monospace fw-bolder'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img
        ...
        <Carousel.Caption>
          <h3 className='text-black font-monospace fw-bolder'>Want to share with others?</h3>
